...
public class DefaultSystemFirmwareTest extends TestCase {
    ...
    DefaultSystemFirmware m_defaultSystemFirmware;
    ...
    public void testGetUploadArgs() {
        ...
        String[] args = {"", uploadSpec, fileSettings.get(0), uploadFiles.get(0), fileSettings.get(1),
                uploadFiles.get(1), fileSettings.get(2), uploadFiles.get(2)
        };

        m_defaultSystemFirmware = new DefaultSystemFirmware(uploadSpec, fileSettings, uploadFiles);

        assertEquals(true, Arrays.equals(args, m_defaultSystemFirmware.getUploadArgs()));
